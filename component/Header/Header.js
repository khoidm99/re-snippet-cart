...
// import CartPage from '../Main/Context/CartPage';
	...
	return (
		<div className={styles.header}>
				...
				<Navbar light expand="lg">
					...
					<Nav className="ml-auto" navbar>
						<NavItem className=" d-flex">
							<Container>
								<a
									className="header__summary snipcart-checkout snipcart-summary mr-2"
									href="#"
			...
			<Menu
				theme="light"
				mode="horizontal"
				defaultSelectedKeys={[router.pathname === '/newlist' ? '2' : router.pathname === '/Cart' ? '3' : '2']}
			>
				<Menu.Item key="1">
					<ReadOutlined />
					<Link href="/newslist">
